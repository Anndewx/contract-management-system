  ...
  const handleSave = async () => {
    if (!formData.name.trim()) {
      Swal.fire({
          icon: 'warning',
          title: 'ข้อมูลไม่ครบ',
          text: 'กรุณาระบุชื่อประเภทอุปกรณ์',
          toast: true,
          position: 'top-end',
    ...
    <div className="container-fluid px-4 py-4" style={{ fontFamily: "'Inter', 'Noto Sans Thai', sans-serif" }}>
      ...
      <div className="d-flex justify-content-between align-items-center mb-4">
        <div>
            ...
            <span className="text-black small ps-1 fw-bold">จัดการข้อมูลประเภทอุปกรณ์ทั้งหมดในระบบ</span>
        </div>
        <button 
        ...
        <div className="table-responsive flex-grow-1">
          <table className="table mb-0 align-middle">
            <thead className="table-header">
              <tr>
                {/* กำหนดความกว้างคอลัมน์ให้สมดุล (20% x 4) + (10% x 2) */}
                <th className="py-3 ps-4 text-start border-0" style={{ width: '20%' }}>ชื่ออุปกรณ์</th>
          ...
          <div className="modal-dialog modal-dialog-centered modal-lg" style={{maxWidth: '600px'}}>
            <div className="modal-content border-0 shadow-lg rounded-4" style={{ overflow: 'hidden' }}>
              ...
              <div className="modal-header border-bottom-0 pb-0 pt-4 px-5">
                <div>
                    <h4 className="modal-title fw-bold text-dark">เพิ่มประเภทอุปกรณ์</h4>
                    <span className="text-muted small">กรอกข้อมูลเพื่อสร้างประเภทอุปกรณ์ใหม่</span>
                </div>
              ...
              <div className="modal-body px-5 py-4">
                <form>
                  <div className="mb-4">
                    <label className="form-label fw-bold small text-dark">ชื่ออุปกรณ์ <span className="text-danger">*</span></label>
                    <input 
                        type="text" 
